import type { EtudiantModel } from "../../../model/etudiant-model";
 ...
 export class FormEtudiantComponent{
    ...
    constructor(public onSubmit: (etudiant: EtudiantModel) => void) {
    ...
    private onSubmitForm(): void {
      this.form.addEventListener("submit", (event) => {
        ...
        this.onSubmit({id:1,
          ...
          prenom:"prenom",
          matricule:"MAT-001",
          classe: {id:1,filiere:"filiere",niveau:"classe",libelle: (filiere, niveau) => `${filiere} - ${niveau}`},
          notes: []}); // Create a new EtudiantModel instance with dummy data
       this.alertComponent(); // Show alert component
    ...
    `
     ...
     get element (): HTMLFormElement {
        return this.form;
         ...
         alertComponent(){
     const containerAlert =   document.getElementById("showAlert") as HTMLDivElement;     
